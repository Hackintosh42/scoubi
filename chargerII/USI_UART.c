...
#define LED_ENABLE_PIN 3
#define LED_ENABLE_PORT PORTB
#define LED_ENABLE_PORT_DDR DDRB
#define WHITELEDS_ON  LED_ENABLE_PORT |= (1<<LED_ENABLE_PIN)
#define WHITELEDS_OFF LED_ENABLE_PORT &= ~(1<<LED_ENABLE_PIN) 
