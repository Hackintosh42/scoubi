...
// if you chose the LCD_PORT_INTERFACE:
		...
		#define LCD_CTRL2_PORT	PORTB
		#define LCD_CTRL2_DDR	DDRB		
		#define LCD_CTRL_E		2   // PD3

		#define LCD_CTRL3_PORT	PORTC
		#define LCD_CTRL3_DDR	DDRC		
		#define LCD_CTRL_RS		5   // PC5
