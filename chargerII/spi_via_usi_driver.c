...
#define USI_CLOCK_PIN	5	//!< USI clock I/O pin.
#define USI_DATAIN_PIN	4	//!< USI data input pin.
#define USI_DATAOUT_PIN	3	//!< USI data output pin.
...
#define TC0_COMPARE_VALUE   250	//!< Must be 0 to 255. Minimum 31 with prescaler CLK/1.
...
/*
	...
	TCCR1A = (1<<WGM01) | TC0_PS_SETTING;
	TCCR1B = (1<<CTC1) | TC0_PS_SETTING;
